...
> trabajo. La tabla no tiene una única respuesta correcta: lo que se evalúa
> es que cada elemento tenga **un solo destino primario** y que los casos
> discutibles vengan con una razón, no con una preferencia.
