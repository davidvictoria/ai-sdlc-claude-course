...
> **Ejemplo de referencia del practitioner.** Es un entregable de nivel
> *Reproducible* (90-100 en la rúbrica), no la única respuesta válida. Un equipo
> puede alcanzar la misma calificación con otra selección de capacidades si la
> justifica.
...
- **Práctica a probar:** aplicar el workflow a los cambios de reglas de negocio
  del servicio de pagos, empezando por uno de los quick wins que el equipo marcó
  en su mapa de oportunidades de la sesión 1.
